...
/**
 *
 * This class acts as a container for all the information of Salsa Virtual
 * Machine instances
 *
...
//	}
    ...
    public static SalsaInstanceDescription_VM fromJson(String json) {
        ObjectMapper mapper = new ObjectMapper();
        try {
            return mapper.readValue(json, SalsaInstanceDescription_VM.class);
