...
import at.ac.tuwien.dsg.salsa.model.toscaDomain.SalsaMappingProperties.SalsaMappingProperty;
...
/**
 *
 * This class acts as a container for all the information of Salsa system
 * process instances
 *
...
public class SalsaInstanceDescription_SystemProcess {
    ...
    public static SalsaInstanceDescription_SystemProcess fromJson(String json) {
        ObjectMapper mapper = new ObjectMapper();
        try {
            return mapper.readValue(json, SalsaInstanceDescription_SystemProcess.class);
