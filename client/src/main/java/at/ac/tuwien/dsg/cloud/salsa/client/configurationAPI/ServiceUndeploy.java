 ...
 * @author hungld
 */
public class ServiceUndeploy implements CommandHandler {
    ...
    @Override
    public void execute() {
        RestHandler.callRest(Main.getSalsaAPI("/services/" + serviceName), RestHandler.HttpVerb.DELETE, null, null, null);
    }
