...
/**
 * This class contain methods for deploying Entities in ToscaGraph included Requirement and node it self
 *
...
public class DeploymentEngineNodeLevel {
    ...
    static {
        String endpoint = SalsaConfiguration.getSalsaCenterEndpointLocalhost();
    ...
    public static String prepareUserData(String serviceId, String topologyId, String nodeId, int replica, SalsaInstanceDescription_VM instanceDesc, TDefinitions def) {
        ...
        // install java. It ad-hoc, will be improve later   ==> removed, just comment for looking back
