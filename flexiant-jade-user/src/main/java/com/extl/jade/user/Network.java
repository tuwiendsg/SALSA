...
/**
 * <p>The Network class is a virtual object representing a layer 2 link between virtual NICs and (possibly) virtual routing devices</p><p>Note that the ipv6RoutingEnabled flag only controls routing of IPv6 by the routing element, i.e. external IPv6 connectivity; it does not mediate whether IPv6 addresses are assigned or whether IPv6 traffic can be passed.
 * 
