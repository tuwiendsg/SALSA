...
/**
 * <p>The ListResult class represents the result of a list call</p><p>The ListResult class contains both the results themselves, as well as a count of the total number of objects available, and indices of the first and last result returned.</p>
 * 
