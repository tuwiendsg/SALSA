...
/**
 * <p>The KeyList class represents a list of resource keys and their values</p><p>Note that as some key types can be multivalued, the value is represented as a JadeList type, i.e. a list of strings.</p>
 * 
