...
/**
 * <p>The DeploymentTemplate class is a template resource holding the details of resources which are deployed when the template is deployed.</p>
 * 
 ...
 *         &lt;element name="instanceChargeProductOfferUUID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="instanceChargeProductOfferName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "deploymentTemplate", propOrder = {
    ...
    "ownerPermission",
    "questions",
    "instanceChargeProductOfferUUID",
    "instanceChargeProductOfferName"
})
@XmlSeeAlso({
    ...
    extends VirtualResource
{
    ...
    protected String instanceChargeProductOfferUUID;
    protected String instanceChargeProductOfferName;
    ...
    /**
     * Gets the value of the instanceChargeProductOfferUUID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getInstanceChargeProductOfferUUID() {
        return instanceChargeProductOfferUUID;
    }

    /**
     * Sets the value of the instanceChargeProductOfferUUID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setInstanceChargeProductOfferUUID(String value) {
        this.instanceChargeProductOfferUUID = value;
    }

    /**
     * Gets the value of the instanceChargeProductOfferName property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getInstanceChargeProductOfferName() {
        return instanceChargeProductOfferName;
    }

    /**
     * Sets the value of the instanceChargeProductOfferName property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setInstanceChargeProductOfferName(String value) {
        this.instanceChargeProductOfferName = value;
    }
