...
/**
 * <p>The Job class is a virtual resource representing a job</p><p>A job is an action within the system. Any non-instantenous action will be represented as a job.</p>
 * 
