...
/**
 * <p>The ProductOffer class holds the base data for each product offer.</p><p>The Product Offer describes how, to whom and at what charge a Product may be sold.</p>
 * 
