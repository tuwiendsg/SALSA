...
/**
 * <p>The QueryResult class contains the result of a complex query.</p><p>The result contains a list of rows, plus a total number of rows, and the indices of the first and last row returned under this query.</p>
 * 
