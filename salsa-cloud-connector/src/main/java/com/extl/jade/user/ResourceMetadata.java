...
/**
 * <p>The ResourceMetadata class implements metadata which can be attached to resources</p><p>Metadata falls into four classes: private, public, restricted and system. These can each be set on any object, though server and image metadata tend to be the most useful. For more information, see the metadata section of the main manual.</p>
 * 
