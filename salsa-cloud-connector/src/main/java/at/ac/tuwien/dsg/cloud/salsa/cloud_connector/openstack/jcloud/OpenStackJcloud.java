...
public class OpenStackJcloud implements CloudInterface, Cloneable{
	...
	public InstanceDescription getInstanceDescriptionByID(String instanceID) {		
			...
			switch (status){
				case ACTIVE: des.setState(VMStates.Running); break;
				case BUILD: des.setState(VMStates.Prolog); break;
				case ERROR: des.setState(VMStates.Failed); break;
				case STOPPED: des.setState(VMStates.Terminated); break;
				case UNKNOWN: des.setState(VMStates.Unknown); break;
				default: des.setState(VMStates.Unknown); break;
			}
			return des;
