 ...
 * These APIs only query information in the database without any execution for collecting real information.
 * For the information collecting, please use communication service APIs.
 * @author Duc-Hung Le
 */
@Path("/unitinstance")
